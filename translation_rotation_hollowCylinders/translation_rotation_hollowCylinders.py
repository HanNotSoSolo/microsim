...
class ForceOnTwoParallelCylinders:
    ...
    def _sum_potential(self, result_pp_R1: RPP, result_pp_R2: RPP):
        """
        This function takes the potential of the R2 framework and sum it to the
        potential generated by the inner test mass in R2 coordinates.
        ...
        # Drawing the result
        plt.tricontourf(coors_R2[:, 0], coors_R2[:, 1], res, 500)
...
#FO2PHC._sum_potential(result_pp_newton[0], result_pp_newton[1])
